...
const TourImages = () => {
  return (
    <div className="bg-card text-card-foreground w-2/3 rounded-3xl py-6 px-4">
      ...
      <span className="">Сделайте ваш тур привлекательнее: загрузите атмосферные фотографии в высоком качестве. 
                        Поддерживаемые форматы: JPG, JPEG, PNG, WEBP. Рекомендуемое минимальное разрешение 960x720 px. 
                        Размер файла до 10MB</span>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              />
                ...
                <span className="font-semibold">Загрузите одну или несколько фотографии</span> 
