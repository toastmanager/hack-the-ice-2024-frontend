...
const TourDescriptionInput = () => {
  return (
    <div className="bg-card text-card-foreground w-4/5 rounded-3xl py-6 px-4 ">
        <div>
        ...
        <div className="space-y-3 pt-4">
            ...
            <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 ">Классификация</label>
            ...
            <option>Язык группы</option>
                ...
                <option>Сигма</option>
                <option>Пендоский</option>
                <option>ЧингЧонг</option>
            </select>
            <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
    ...
    <div className="grid w-full items-center gap-1.5 mt-5">
      <Label htmlFor="videoUrl">Ссылка на видео YouTube о туре (не обязательно)</Label>
      <Input type="videoUrl" id="videoUrl" placeholder="Вставьте ссылку" />
    </div>
        </form>
     </div>
    </div>
