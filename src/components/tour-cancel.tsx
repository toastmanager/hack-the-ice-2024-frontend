...
const TourCancel = () => {
  ...
  return (
    <div className="bg-card text-card-foreground w-full rounded-3xl p-5 space-y-4">
      ...
      <div
        className={`bg-[#F2F2F2] w-full px-4 rounded-md border ${getBorderClass(
          1
        )}`} /* border changes div?? */
        ...
        <div className="grid grid-cols-3">
          <div className="p-4">
            ...
            <p className="text-gray-400 text-sm">
              Не позднее чем за 15 дней до начала тура или в течение 24 часов
              после бронирования.
            </p>
          </div>
          <div className="p-4">
      ...
      >
        <div className="flex items-center mt-4">
          <span className="text-2xl font-semibold py-3 px-3">
            Очень строгие
          </span>
        </div>
        <div className="grid grid-cols-3">
          <div className="p-4">
            ...
            <p className="text-gray-400 text-sm">
              В течение 24 часов после бронирования путешественнику возвращается
              100%, по истечении этого срока путешественнику не возвращаются
              средства
            </p>
          </div>
          <div className="p-4">
